...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="clone_driver.codex_advisor")
...
def main() -> int:
    ...
    with tempfile.NamedTemporaryFile(prefix="clone-driver-codex-", suffix=".json", delete=False) as output:
